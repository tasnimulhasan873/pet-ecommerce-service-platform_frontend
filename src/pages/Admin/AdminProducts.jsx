      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-8 flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
          <div className="flex items-center w-full md:w-auto">
            <div className="bg-gradient-to-br from-[#002A48] to-[#004080] p-3 md:p-4 rounded-2xl shadow-lg mr-4 flex-shrink-0">
              <FontAwesomeIcon
                icon={faBox}
            ...
            <div>
              <h1 className="text-2xl md:text-4xl font-bold text-[#002A48] mb-1">
                Product Management
              </h1>
          ...
          <div className="w-full md:w-auto">
            <button
              ...
              className="w-full md:w-auto bg-gradient-to-r from-green-500 to-green-600 text-white px-4 md:px-6 py-2 md:py-3 rounded-xl font-semibold hover:from-green-600 hover:to-green-700 transition shadow-lg flex items-center justify-center md:justify-start gap-2"
            >
                ...
                <div className="p-6">
                  ...
                  <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-4 gap-4">
                    ...
                    <div className="text-right sm:text-right">
                      ...
                      <p className="font-semibold text-[#002A48] truncate max-w-[140px]">
                        {product.brand}
                      </p>
                    </div>
                  </div>
